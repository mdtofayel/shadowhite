 ...
 */
@Controller
@RequestMapping("/Admin/threeD/user")
public class UserInfoControllerThreeD extends AppController {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    @Qualifier("userServiceForAdminThreeD")
    @Autowired
