...
import com.theme.domain.DigitalItemRating;
import com.theme.domain.DigitalItems;
import com.theme.repository.DigitalItemsRepositoy;
...
public class DigitalItemsServiceImpl implements DigitalItemsService{
    ...
    @Autowired
    public void setDigitalItemsRepositoy(@Qualifier("digitalItemsRepositoy") DigitalItemsRepositoy digitalItemsRepositoy) {
